                ...
                if($userStatus == 'Y')
                {
                    ...
                    if($groupid != 'GUEST')
                    {
                        ...
                        curl_setopt_array($curl_getUserExist, array(
                            CURLOPT_URL => "https://svr02.kencana.org/service/api/getUserExist?email=".$userid."@".$userid.".com",
                        ...
                        if ($err_getUserExist) {
                            ...
                            if ($count < 1){
                                ...
                                curl_setopt_array($curl_register, array(
                                    CURLOPT_URL => "https://svr02.kencana.org/service/api/register",
                                    CURLOPT_RETURNTRANSFER => true,
                                    CURLOPT_ENCODING => "",
                                ...
                                curl_setopt_array($curl_login, array(
                                    CURLOPT_URL => "https://svr02.kencana.org/service/api/login",
                                    CURLOPT_RETURNTRANSFER => true,
                                    CURLOPT_ENCODING => "",
                                    CURLOPT_MAXREDIRS => 10,
                                    CURLOPT_TIMEOUT => 30000,
